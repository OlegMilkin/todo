...
const TaskItem = (
  ...
  const changeTaskText = () => {
    setNewTaskText(editInput.current.value)
  }
  ...
  let labelCompleteClass = isTaskCompleted
    ? `list-group-item ${classes.listGroupItem} ${classes.listItemCompleted}`
    : `list-group-item ${classes.listGroupItem}`
  ...
  return (
    ...
    >
      ...
      <button
        className={classes.listItemEdit}
